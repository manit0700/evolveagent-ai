  ...
  it('passes execute and returns the answer + route metadata', async () => {
    const fetchMock = vi.fn(async () => ({
      ...
      json: async () => ({
        ...
        workspace_id: 'w1',
        memory_used: true,
        workspace_memory_used: [{ memory_id: 'm1', title: 'Resume preference', type: 'preference', source: 'manual', content: 'Use concise bullets for resume projects.' }],
        sources: [{ label: 'Project Brain', source_type: 'memory', source_route: '/api/memory-v2/search', snippet: 'Matched resume project knowledge.' }],
        tool_trace: [{
          ...
          sanitized_input: 'resume project',
          result_summary: 'Found one matching memory',
          risk_level: 'low',
        }],
    ...
    expect(res).toMatchObject({
      ...
      context: {
        ...
        memoryCount: 1,
        knowledgeHits: 1,
        memorySources: [{ id: 'm1', title: 'Resume preference', type: 'preference', source: 'manual', snippet: 'Use concise bullets for resume projects.' }],
        knowledgeSources: [{ id: '/api/memory-v2/search', label: 'Project Brain', type: 'memory', source: '/api/memory-v2/search', snippet: 'Matched resume project knowledge.' }],
        ...
        toolPreviews: [{
          ...
          sanitizedInput: 'resume project',
          resultSummary: 'Found one matching memory',
          riskLevel: 'low',
          status: 'selected',
        }],
        verificationChecks: [
