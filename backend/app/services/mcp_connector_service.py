...
DEFAULT_TEMPLATES: list[dict] = [
    {
        ...
        "env_keys_required": [],
        "capabilities": ["read approved project files", "list approved project directories", "propose file edits"],
        "allowed_actions": ["read_approved_file", "list_approved_directory", "propose_file_edit"],
    ...
    },
    {
        ...
        "server_type": "local_mock",
        "env_keys_required": [],
        "capabilities": ["git status", "git diff", "branch info", "commit with approval"],
        "allowed_actions": ["git_status", "git_diff", "branch_info", "commit_with_approval"],
