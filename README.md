...
**Current completed version:** v62 — Global Search Across Everything &nbsp;•&nbsp; **Latest pass:** v45.1 — MCP Hub UI &nbsp;•&nbsp; **Platform base:** EvolveAgent OS
...
- `GET /api/transcription/status` returns transcription mode, active provider, model, fallback provider, and readiness message.
